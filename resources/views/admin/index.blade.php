...
<div id="app" class="wrapper">
	<header class="main-header">
		...
		<!-- Logo-->
		<a href="" class="logo">
			<span class="logo-mini"><b>Vet</b> Tienda</span>
			<span class="logo-lg"><b>Tuvetdoctor</b> Tienda</span>
		</a>
		...
		<section class="sidebar">
			...
			<ul class="sidebar-menu" data-widget="tree">
				...
				<router-link to="/" tag="li" active-class="active" exact>
					<a href=""><i class="glyphicon glyphicon-home"></i> <span>Inicio</span></a>
				</router-link>
				
				<!-- Manage Category -->
				<router-link to="/category" tag="li" active-class="active">
					<a href=""><i class="glyphicon glyphicon-th-large"></i> <span>Categorias</span></a>
				</router-link>

				<!-- Manage Subcategory -->
				<router-link to="/subcategory" tag="li" active-class="active">
					<a href=""><i class="glyphicon glyphicon-th-list"></i> <span>Subcategoria</span></a>
				</router-link>
				...
				<li class="treeview" :class="{'active':$route.path.match('products')}">
					...
					<ul class="treeview-menu">
						<li class="header child-active">Seleccionar Categoria</li>
						<li 
				...
				<li class="treeview" :class="{'active':$route.path.match('order/')}">
					<a href="#"><i class="fa fa-ship"></i> <span>Ordenes</span>
				...
				<router-link v-if="admin.id==1" tag="li" to="/admin" active-class="active">
					<a href="#"><i class="fa fa-shield"></i> <span>Admin</span></a>
				</router-link>>
			</ul>
