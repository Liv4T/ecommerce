...
<div>
	<div class="form-group">
		<router-link :to="`/order/${type}`" class="btn btn-default white">&lt; Atras</router-link>
		<button 
	...
	<div class="row">
		...
		<div class="col-md-6">
			<div class="panel panel-default">
				<div class="panel-body">
					<h4><b>Detalles de la orden</b></h4>
	...
	<modal id="cancelModal">
		...
		<modal-body>
			<h1>Estas seguro de cancelar la oden?</h1>
		</modal-body>
		<modal-footer>
			<button class="btn btn-danger" @click="cancelOrder()">Cancelar orden</button>
	...
	<modal id="completeModal">
		...
		<modal-body>
			<h1>Estas seguro de la orden esta completa?</h1>
		</modal-body>
		<modal-footer>
