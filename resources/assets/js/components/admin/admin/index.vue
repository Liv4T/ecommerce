...
<div class="col-md-8 col-md-offset-2">
	...
	<modal id="deleteAdminModal">
		<modal-header>Borrar Admin</modal-header>
		<modal-body>
			<h1>Seguro quieres borrar el admin?</h1>
		</modal-body>
		<modal-footer>
			<button class="btn btn-danger" @click="deleteAdmin">Borrar Admin</button>
			<button class="btn btn-default" onclick="util.hideModal('#deleteAdminModal')">Cancelar</button>
		</modal-footer>
	</modal>
</div>
</template>
