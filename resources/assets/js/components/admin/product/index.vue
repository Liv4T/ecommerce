...
<div class="row">
				...
				<div id="collapse1" class="panel-collapse collapse">
					<ul class="list-group">
						<router-link 
							...
							active-class="active">Todas las Subcategorias</router-link>
						<li 
	...
	<modal id="deleteProductModal">
		...
		<modal-body>
			<p>Estas seguro de borrar el producto?</p>
			<p><b>Advertencia : </b>Borrar un producto no se puede deshacer</p>
		</modal-body>
		<modal-footer>
			<button class="btn btn-danger" @click="deleteProduct(product_id)">Borrar</button>
