			...
			<div class="col-md-8">
				...
				<div class="form-group">
					...
					<select class="form-control" name="subcategory_id" v-model="subcategory_id" required>
						<option value="0" disabled>-- Ninguna subcategoria seleccionada --</option>
				...
				<div class="form-group">
					...
					<div class="input-group">
						...
						<div class="form-control" style="text-align: center;">
							...
							<b><span>{{ product_quantity }}</span> en stock</b>
						</div>
						<div class="input-group-btn">
				...
				<div class="pull-right">
					...
					<input type="button" class="btn btn-default" value="Atras" @click="back()"/>
				</div>
			</div>
