...
<div class="panel panel-default col-md-8 col-md-offset-2">
	...
	<modal id="deleteCategoryModal">
		<modal-header>Borrar categoria</modal-header>
		<modal-body>
			<p><b>Advertencia :</b> Cuando se borrar la categoria tambien se borrar las subcategorias que se tengan</p>
		</modal-body>
		<modal-footer>
			<button class="btn btn-danger" v-on:click="deleteCategory(getCategoryId())">Borrar</button>
...
export default {
	...
	methods: {
		...
		refreshCategories: function() {
			var vm = this;
			util.notify('Actualizando categorias', 'loading');
		...
		initDatatable: function(rows) {
			...
			$('#categories').DataTable({
				...
				buttons:[
					{
						text: '<span class="fa fa-plus"></span> Agregar Categoria',
					...
					{
						text: '<span class="fa fa-refresh"></span> Actualizar',
