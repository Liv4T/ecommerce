...
<div class="container">
	<div class="col-md-9">
		<div class="panel panel-default">
			<div class="panel-body">
				<router-link class="btn btn-default" to="/order"> &lt; Atras</router-link>
				<button class="btn btn-danger" v-if="_new" onclick="util.showModal('#cancelModal')">Cancelar Orden</button>
				<h2>Detalles de la orden</h2>
				<h6>Tienes {{ totalItem }} items.</h6>
	...
	<modal id="cancelModal">
		...
		<modal-footer>
			<button class="btn btn-danger" @click="cancel">Cancelar Orden</button>
