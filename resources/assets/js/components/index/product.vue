	...
	<div class="container">
		<div class="row" v-if="subcategories.length>0">
			<div class="col-md-3" style="max-width: 250px;">
				<ul class="list-group" >
					<router-link tag="li" class="list-group-item" :to="{params:{subcategory_id:0}}" active-class="active">Subcategorias</router-link>
					<router-link 
			...
			<div class="col-md-9" v-else>
				<div class="jumbotron"><h1>No hay Productos</h1></div>
			</div>
		</div>
		<div class="jumbotron" v-else><h1>No hay Productos</h1></div>
	</div>
</template>
